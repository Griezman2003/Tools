<x-filament::page>
    <form wire:submit.prevent="descargar" class="space-y-6 w-full mx-auto md:px-0">
        <div class="w-full max-w-12xl mx-auto">
            <label for="musica_url" class="block text-sm font-medium text-gray-700 dark:text-gray-500 mb-2">
                URL del video (YouTube)
            </label>
            <input
                id="musica_url"
                type="url"
                wire:model.defer="musica_url"
